...
//                });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.mDownload:
                Toast.makeText(Question_PdfViewing.this, "Download Started", Toast.LENGTH_SHORT).show();
                mBuilder = new NotificationCompat.Builder(Question_PdfViewing.this);
    ...
    public class Downloader extends AsyncTask<String,Integer,Integer> {
        ...
        protected void onPostExecute(Integer integer) {
            ...
            mNotifyManager.notify(1,mBuilder.build());
            Toast.makeText(Question_PdfViewing.this, "Download Complete", Toast.LENGTH_SHORT).show();
